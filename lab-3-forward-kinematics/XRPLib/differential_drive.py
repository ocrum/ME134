...
class DifferentialDrive:
    ...
    async def async_turn(self, turn_degrees: float, max_effort: float = 0.5, timeout: float = None, main_controller: Controller = None, secondary_controller: Controller = None, use_imu:bool = True) -> bool:
        """
        Asynchronous version of turn functino
        """
